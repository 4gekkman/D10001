...
@section('title')
  ...
  <title>D10001 - Dashboard Demonstration</title>
...
@section('css')
  ...
  <link rel="stylesheet" type="text/css" href="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10001/css/c.css?rand={!! mt_rand(1000,9999); !!}">
  <!-- document css: stop -->
...
Оглавление
  ...
  1. Заголовок и хлебные крошки
  2. Несколько виджетов
  3. Бокс с графиками и данными
  4. Основная часть со всякими-разными элементами
...
@section('content')
  ...
  <section class="content-header content-header-my">
    <h1>
      Demonstration
      <small>of the dashboard features</small>
    </h1>
    <ol class="breadcrumb breadcrumb-my">
      <li><a href="#"><i class="fa fa-flash"></i>Demonstration</a></li>
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="chart">
            <!-- Sales Chart Canvas -->
            <canvas id="salesChart" style="height: 180px; width: 818px;" width="1022" height="225"></canvas>
          </div>
          <!-- /.chart-responsive -->
        </div>
        <!-- /.col -->
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="{!! asset('public/bower/AdminLTE/dist/img/user1-128x128.jpg') !!}" alt="message user image"><!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg right">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="{!! asset('public/bower/AdminLTE/dist/img/user3-128x128.jpg') !!}" alt="message user image"><!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
              ...
              <div class="direct-chat-contacts">
                <ul class="contacts-list">
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="{!! asset('public/bower/AdminLTE/dist/img/user1-128x128.jpg') !!}" alt="User Image">
                  ...
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="{!! asset('public/bower/AdminLTE/dist/img/user7-128x128.jpg') !!}" alt="User Image">
                  ...
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="{!! asset('public/bower/AdminLTE/dist/img/user3-128x128.jpg') !!}" alt="User Image">
                  ...
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="{!! asset('public/bower/AdminLTE/dist/img/user5-128x128.jpg') !!}" alt="User Image">
                  ...
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="{!! asset('public/bower/AdminLTE/dist/img/user6-128x128.jpg') !!}" alt="User Image">
                  ...
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="{!! asset('public/bower/AdminLTE/dist/img/user8-128x128.jpg') !!}" alt="User Image">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body no-padding">
              <ul class="users-list clearfix">
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user1-128x128.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">Alexander Pierce</a>
                  <span class="users-list-date">Today</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user8-128x128.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">Norman</a>
                  <span class="users-list-date">Yesterday</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user7-128x128.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">Jane</a>
                  <span class="users-list-date">12 Jan</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user6-128x128.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">John</a>
                  <span class="users-list-date">12 Jan</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user2-160x160.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">Alexander</a>
                  <span class="users-list-date">13 Jan</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user5-128x128.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">Sarah</a>
                  <span class="users-list-date">14 Jan</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user4-128x128.jpg') !!}" alt="User Image">
                  <a class="users-list-name" href="#">Nora</a>
                  <span class="users-list-date">15 Jan</span>
                </li>
                <li>
                  <img src="{!! asset('public/bower/AdminLTE/dist/img/user3-128x128.jpg') !!}" alt="User Image">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="chart-responsive">
                <canvas id="pieChart" height="195" width="305" style="width: 244px; height: 156px;"></canvas>
              </div>
              <!-- ./chart-responsive -->
            </div>
            <!-- /.col -->
          ...
          <ul class="products-list product-list-in-box">
            <li class="item">
              <div class="product-img">
                <img src="{!! asset('public/bower/AdminLTE/dist/img/default-50x50.gif') !!}" alt="Product Image">
              </div>
...
@section('js')
  ...
  <script src="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10001/js/j.js?rand={!! mt_rand(1000,9999); !!}"></script>
  <!-- document js: stop -->

  <script src="{!! asset('public/bower/AdminLTE/dist/js/pages/dashboard2.js') !!}"></script>
  <script src="{!! asset('public/bower/AdminLTE/dist/js/demo.js') !!}"></script>
