...
@section('css')
  ...
  <link rel="stylesheet" type="text/css" href="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10001/css/c.css">
  <!-- document css: stop -->
...
@section('js')
  ...
  <script src="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10001/js/j.js"></script>
  <!-- document js: stop -->
